...
public class ModifierUtilisateurCR {
	...
	public ModifierUtilisateurCR()
	{
		
	}
	
	public ModifierUtilisateurCR(EnvoiEnteteCR entete, String matricule, String nom, String prenom,
	...
	public String sendXML()
	{
		...
		LOGGER.info("***** Envoi d'un message à CRM : demande de modification du matricule : " + matricule + ".");
		
		result.append("<XML>");
		result.append(entete.sendXML());
		result.append("<COMPTE civilite=\"" + civilite 
				+ "\" nom=\"" + nom + "\""
				+ " matricule=\"" + matricule + "\""
				+ " prenom=\"" + prenom + "\""
				+ " adresse=\"" + adresse + "\""
