...
public class DomParserCRM extends DomParser
{
	public DomParserCRM()
	{
	}
	...
	public Sale saleTicket(String xml)
	{
		...
		sale.customerNumber = DomParserHelper.getNodeAttr("refclient", saleNode); // NBA : Pourquoi pas customernumber ? si changement, penser au constructor
