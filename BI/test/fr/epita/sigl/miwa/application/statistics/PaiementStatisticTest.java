...
public class PaiementStatisticTest {
	...
	public void cbToStringTest() {
		paiementStatistic = new PaymentStatistic(null, EPaiementType.CB, 10000, 10);
	...
	public void cfToStringTest() {
		paiementStatistic = new PaymentStatistic(null, EPaiementType.CF, 10000, 10);
	...
	public void cqToStringTest() {
		paiementStatistic = new PaymentStatistic(null, EPaiementType.CQ, 10000, 10);
	...
	public void esToStringTest() {
		paiementStatistic = new PaymentStatistic(null, EPaiementType.ES, 10000, 10);
